...
print('%.3f, %.3f, %.2f, %.2f, %.2f, %.2f, %.2f, %.2f, %.2f, %.2f, %.2f' % (Hs_off10, Hs_sz10, xsz10, xsl10, xr10, Tp_off10, Tp_sz10, dir_off10, dir_sz10, theta_off10, theta_sz10))
...
f = open('/gscratch/nearshore/enuss/lab_runs_y550/postprocessing/wave-stats.tex', 'w')
f.write(r'\begin{table}[t!]')
f.write('\n')
f.write(r'\caption{Significant wave height ($H_s$), peak period ($T_p$), wave direction ($\theta$), and directional spread ($\sigma_\theta$) input to numerical wavemaker, measured offshore between wavemaker and toe of the beach slope ($x$ = $15\ \mathrm{m}$), and at the offshore surf zone edge ($x_{sz}$). Additionally, the mean water level ($x_{sl}$) and lowest extent of rundown ($x_r$) are reported for determining surf zone box area ($A_{sz}$)}\label{t1}')
f.write('\n')
...
f.write(r'\hline')
f.write('\n')
f.write(r'Location & Statistic & \textit{M2a} & \textit{M2b} & \textit{M2c} & \textit{M2d} & \textit{M2e} & \textit{M2f} & \textit{M15d} & \textit{M25d} \\')
f.write('\n')
f.write(r'\hline')
f.write('\n') 
f.write(r'~ & $H_s$ (m) & 0.25 & 0.25 & 0.25 & 0.25 & 0.25 & 0.25 & 0.25 & 0.25 \\')
f.write('\n')
f.write(r'Input & $T_p$ (s) & 2 & 2 & 2 & 2 & 2 & 2 & 1.5 & 2.5 \\')
f.write('\n')
f.write(r'~ & $\theta (^{\circ})$ & 0 & 0 & 0 & 0 & 0 & 0 & 0 & 0 \\')
f.write('\n') 
f.write(r'~ & $\sigma_{\theta}~(^{\circ})$ & 1.0 & 5.0 & 10.0 & 20.0 & 30.0 & 40.0 & 20.0 & 20.0 \\')
f.write('\n')
f.write(r'\hline')
f.write('\n')
f.write(r'Wavemaker & $N_{theta}$ & 5 & 15 & 25 & 25 & 25 & 25 & 25 & 25  \\')
f.write('\n')
f.write(r'Inputs & $N_{freq}$ & 500 & 1500 & 2500 & 2500 & 2500 & 2500 & 2500 & 2500 \\')
f.write('\n')
f.write(r'\hline')
f.write('\n')
f.write(r'~ & $H_s$ (m) & %0.2f & %0.2f & %0.2f & %0.2f & %0.2f & %0.2f & %0.2f & %0.2f \\' % (Hs_off1, Hs_off5, Hs_off10, Hs_off20, Hs_off30, Hs_off40, Hs_off20_15, Hs_off20_25))
f.write('\n')
f.write(r'Offshore & $T_p$ (s) & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f \\' % (Tp_off1, Tp_off5, Tp_off10, Tp_off20, Tp_off30, Tp_off40, Tp_off20_15, Tp_off20_25))
f.write('\n')
f.write(r'($x$ = 15$\mathrm{m}$) & $\theta~(^{\circ})$ & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f \\' % (theta_off1, theta_off5, theta_off10, theta_off20, theta_off30, theta_off40, theta_off20_15, theta_off20_25))
f.write('\n')
f.write(r'~ & $\sigma_{\theta}~(^{\circ})$ & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f \\' % (dir_off1, dir_off5, dir_off10, dir_off20, dir_off30, dir_off40, dir_off20_15, dir_off20_25))
f.write('\n')
f.write(r'\hline') 
f.write('\n')
f.write(r'Surf zone edge & $x_{sz}$ (m) & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f \\' % (xsz1, xsz5, xsz10, xsz20, xsz30, xsz40, xsz20_15, xsz20_25))
f.write('\n')
f.write(r'\hline')
f.write('\n')
f.write(r'~ & $H_s$ (m) & %0.2f & %0.2f & %0.2f & %0.2f & %0.2f & %0.2f & %0.2f & %0.2f \\' % (Hs_sz1, Hs_sz5, Hs_sz10, Hs_sz20, Hs_sz30, Hs_sz40, Hs_sz20_15, Hs_sz20_25))
f.write('\n')
f.write(r'Surf zone & $T_p$ (s) & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f \\' % (Tp_sz1, Tp_sz5, Tp_sz10, Tp_sz20, Tp_sz30, Tp_sz40, Tp_sz20_15, Tp_sz20_25))
f.write('\n')
f.write(r'edge ($x = x_{sz}$)  & $\theta~(^{\circ})$ & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f \\' % (theta_sz1, theta_sz5, theta_sz10, theta_sz20, theta_sz30, theta_sz40, theta_sz20_15, theta_sz20_25))
f.write('\n')
f.write(r'~ & $\sigma_{\theta}~(^{\circ})$ & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f & %0.1f \\' % (dir_sz1, dir_sz5, dir_sz10, dir_sz20, dir_sz30, dir_sz40, dir_sz20_15, dir_sz20_25))
f.write('\n')
f.write(r'\hline')
f.write('\n') 
f.write(r'\end{tabular}}')
f.write('\n')
f.write(r'\label{tab:wave_conditions}')
f.write('\n')
f.write(r'\end{table}')
f.write('\n')
f.write(r'\FloatBarrier')
f.close()